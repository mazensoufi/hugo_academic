...
Mazen Soufi is an assistant professor of information science at Imaging-based Computational Biomedicine lab in Nara Institute of Science and Technology (NAIST). My research focuses on the analysis of disease progression trends based on morphological and intensity features dervied from medical images. In my work, I leverage state-of-the-art algorithms for automated image segmentation to obtain the target organs/structures and perform downstream analysis. 
I worked before in projects involving the analysis of lung cancers in CT images and liver fibrosis in MR images. Currently interested in the analysis of musculoskeletal structures to have insights into the age- and disease-related variations. I finally aim at coming up with novel image-based biomarkers to be used in precision medicine to enhance the diagnosis and decision-making processes.
